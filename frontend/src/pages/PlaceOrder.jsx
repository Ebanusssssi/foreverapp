...
const PlaceOrder = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      switch (method) {
        ...
        const responseStripe = await toast.promise(
  ...
  return (
    <form
      ...
      className="flex flex-col sm:flex-row sm:justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t "
    >
      {/* Left Side */}
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px] sm:min-w-[300px]">
      ...
      {/* Right Side */}
      <div className="mt-8 sm:pl-4">
        <div className="sm:mt-12 min-w-[200px] sm:min-w-[200px] md:min-w-80">
          <CartTotal />
        </div>
        <div className="mt-12">
